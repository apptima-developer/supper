...
export const ticketServiceNowSchema = z.object({
  ...
  externalCustomerKey: z.string().max(600).optional(),
  externalCustomerId: z.string().max(500).optional(),
  externalCustomerName: z.string().max(500).optional(),
  customerMappingId: z.string().max(200).optional(),
  customerMappingAppliedAt: z.string().datetime().optional(),
