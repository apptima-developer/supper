...
function ticket(id: string, mdUsed: number, chargeable: boolean): Ticket { return { id, issueId: id, date: "2026-06-01", customerKey: customer.key, customerName: "Acme", issueTitle: "Issue", issueType: "Incident", category: "", severity: "P3", owner: "Agent", ownerEfforts: [{ owner: "Agent", hours: mdUsed * 8 }], status: "00 - Open", kanbanStatus: "open", startDate: "", dueDate: "", closeDate: "", mdUsed, chargeable, remark: "", ticketLogs: [], slaPauses: [], createdAt: now, updatedAt: now }; }
